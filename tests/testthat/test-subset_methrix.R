...
test_that("selected by regions", {
  ...
  expect_equal(subset_methrix(methrix_data, contigs = "chr21"), methrix_data[which(methrix_data@elementMetadata$chr=="chr21"),])
})
...
test_that("selected by regions", {
  ...
  expect_equal(subset_methrix(m2, contigs = "chr21"), m2[which(m2@elementMetadata$chr=="chr21"),])
})
